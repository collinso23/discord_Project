...
from . import weapons, race, background, spells, armor, monsters, exceptions, magic_items
...
class Character(object):
    ...
    """
    Initiliazes a list of classes that the user can choose from.
    might not be needed as class should be populated by the DnD_DB_Scrapper
...
def read_character_file(filename):
    ...
    version_re = re.compile('inqGen_version\s*=\s*[\'"]([0-9.]+)[\'"]')
